  ...
  return (
    <div name="habilidades" className='bg-white'>
        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='md:text-7xl text-blue-950 font-bold mb-5 inline border-b-8 border-blue-600 '>Experiencia y Habilidades</p>
                <p className='text-blue-900 font-bold mt-10 md:text-2xl transform hover:-translate-y-4 duration-500'>Estos son los Lenguajes y tecnologías que he trabajado</p>
            </div>
        ...
        {/* LOGO TAILWINDCSS */}
                <div className='border-4 p-5 rounded-lg shadow-lg hover:scale-110 hover:border-blue-300 duration-500'>
                    <img className='w-20 mx-auto' src={Logo_Tailwind} alt="logo_tailwind" />
                    <p className='font-bold text-blue-800'>TailwindCSS</p>
                </div>

                <div className='border-4 p-5 rounded-lg shadow-lg hover:scale-110 hover:border-blue-300 duration-500'>
                    <img className='w-20 mx-auto' src={Logo_CSS} alt="logo_css" />
