    ...
    <div name="proyectos" className='w-full md:h-screen text-gray-300 bg-[#0f2c58]'>
        ...
        <div className="m-0  bg-blue-100 grid sm:grid-cols-2 md:grid-cols-3 gap-4 border-2 shadow-md shadow-black border-blue-900 rounded-lg  w-max p-2">
            <div className='bg-black rounded-lg'>
                <h2 className='text-center text-blue-500 font-bold p-1 rounded-lg'>Aplicación realizada en JS, HTML, TailwindCss y ReactJS</h2>
               ...
               >
                    ...
                    <div className='opacity-0 group-hover:opacity-100  ml-1 mb-0'>
                                         <ReactPlayer url={Video_AppTareas} controls width='370px' height='200px '  />     
                            <div className='pt-0 text-center'>
                            <button className=' text-center rounded-lg px-1 mt-1 bg-blue-700 text-white text-md w-full'>App To-Do-Ir al Código </button>
                        </div>
                    </div>                    
                </div>
            </div>
                                ...
                                {/* fin 1 tarjeta */}
                 <div className='bg-black rounded-lg'>
                <h2 className='text-center font-bold p-1  text-blue-500'>Simulacion Trello-Se usó JS-HTML y CSS</h2>
               ...
               >
                    {/* Efectos Hover */}    
                    <div className='opacity-0 group-hover:opacity-100  ml-1 mb-0'>
                                         <ReactPlayer url={Video_Trello} controls width='370px' height='200px '  />     
                            <div className='pt-0 text-center'>
                            <button className=' text-center rounded-lg px-1 mt-1 bg-blue-700 text-white text-md w-full'>App Trello-Ir al Código </button>
                        </div>
                    </div>                    
                </div>
            </div>
                ...
                {/*  */}
                <div className='bg-black rounded-lg'>
                <h2 className='text-center font-semibold p-1 rounded-lg text-blue-500'>App hecha en JS, HTML, TailwindCss, ReactJS y Type Script</h2>
               ...
               >
                    {/* Efectos Hover */}    
                    <div className='opacity-0 group-hover:opacity-100  ml-1 mb-0'>
                                         <ReactPlayer url={Video_Ahorcado} controls width='370px' height='200px '  />     
                            <div className='pt-0 text-center'>
                            <button className=' text-center rounded-lg px-1 mt-1 bg-blue-700 text-white text-md w-full'>App Juego Ahorcado-Ir al Código</button>
                        </div>
                    </div>                    
                </div>
            </div>
                ...
                {/*  */}
                 <div className='bg-black rounded-lg'>
                <h2 className='text-center text-blue-500 font-bold p-1 rounded-lg'>App realizada en JS, HTML, TailwindCss y ReactJS</h2>
               ...
               >
                    {/* Efectos Hover */}    
                    <div className='opacity-0 group-hover:opacity-100  ml-1 mb-0'>
                                         <ReactPlayer url={Video_Lista_Contactos} controls width='370px' height='200px '  />     
                            <div className='pt-0 text-center'>
                            <button className=' text-center rounded-lg px-1 mt-1 bg-blue-700 text-white text-md w-full'>App To-Do-Ir al Código </button>
                        </div>
                    </div>                    
               ...
               >
                    {/* Efectos Hover */}    
                    <div className='opacity-0 group-hover:opacity-100  ml-1 mb-0'>
                                         <ReactPlayer url={Video_Formulario} controls width='370px' height='200px '  />     
                            <div className='pt-0 text-center'>
                            <button className=' text-center rounded-lg px-1 mt-1 bg-blue-700 text-white text-md w-full'>App To-Do-Ir al Código </button>
                        </div>
                    </div>                    
