...
export const About = () => {
  return (
    <div name ='about' className='w-full h-full bg-blue-900 text-gray-300 pt-5'>
        <div className='flex flex-col justify-center items-center w-full h-full '>
            <div className='max-w-[1000px] w-full px-[100px] grid grid-cols-2 gap-4 '>
                <div>
                    <p 
                    className=' md:text-6xl text-3xl font-bold inline border-b-4 border-white-500 text-white '>
            ...
            rounded-lg bg-white shadow-sm shadow-black my-10">
                ...
                <div className="">
                    <p className='  md:text-2xl text-justify text-blue-700 font-semibold p-5 transform hover:-translate-y-4 duration-500'>
